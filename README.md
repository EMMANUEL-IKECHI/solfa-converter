...
1. The user selects a major key from the dropdown menu.  
2. The user enters a sequence of solfège syllables.  
3. The app dynamically maps each syllable to the corresponding note based on the selected key.  
4. The converted notes are displayed immediately for reference or further use.  
